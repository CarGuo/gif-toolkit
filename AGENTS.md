...
2. **Plan** → 用 TodoWrite 列出步骤;影响 R-01..R-16 / R-22..R-26 中任何一条要在计划里点名。
3. **Execute** → 改代码。
...
- **[harness/](file:///Users/guoshuyu/workspace/gif-toolkit/harness)** —— 工程级 harness 规则与回归场景库
  ...
  - **[harness/rules/](file:///Users/guoshuyu/workspace/gif-toolkit/harness/rules)** —— R-01..R-16 + R-22..R-26 的细化版,每条一个文件
...
- [ ] 我读了 AGENTS.md 第 1 节(R-01..R-16 + R-22..R-26),没违反任何一条
